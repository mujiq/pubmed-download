...
NAV = [
 ...
 ("3 · Data quality & degradation", [("progressive-data.html", "Progressive data & degradation"),
                 ...
                 ("wearable-baseline-pipeline.html", "Wearable baseline pipeline"),
                 ("baseline-mob-viz.html", "Baseline mobile UI")]),
 ("4 · Making it personal", [(DOCMAP["08"], SHORT["08"], "08"), (DOCMAP["09"], SHORT["09"], "09"),
 ...
 ("5 · Acting on it", [(DOCMAP["11"], SHORT["11"], "11"), (DOCMAP["12"], SHORT["12"], "12"),
                 ("appendix-adherence.html", "Adherence"), ("appendix-goals.html", "Goals"),
                 ("feedback-loop.html", "Feedback-loop demo")]),
 ("6 · Care pathways & delivery", [("care-pathways.html", "Condition pathways"),
                 ("care-roles.html", "Care team & roles"),
                 ("prevention-engagement.html", "Prevention & engagement")]),
 ("7 · Trust & govern", [(DOCMAP["13"], SHORT["13"], "13"), (DOCMAP["14"], SHORT["14"], "14"),
 ...
 ("8 · Gaps, blind-spots & roadmap", [("production-gaps.html", "Production readiness — gaps"),
 ...
 ("9 · System & build", [("purescore-system.html", "System at a glance"),
...
NAV_BLURB = {
 ...
 "3 · Data quality & degradation": "What happens to inputs: graceful degradation, cohort fallback, the cohort dataset, and the wearable baseline pipeline.",
 "4 · Making it personal": "Context that reshapes the score: sex, life-stage, conditions, personas.",
 "5 · Acting on it": "Turning the score into nudges, actions, adherence and goals.",
 "6 · Care pathways & delivery": "How the engine plugs into real care: pathways, roles, and prevention/engagement.",
 "7 · Trust & govern": "Validation, safety, evidence, fairness, localization and actuarial.",
 "8 · Gaps, blind-spots & roadmap": "What's missing or partial — product gaps, the spec audit, the clinician red-team and coverage audit.",
 "9 · System & build": "The whole machine end-to-end: state machines, the object model, ERD, C4, API, stories.",
 "10 · Admin (clinician config)": "The clinician configuration & sign-off surfaces.",
}
...
CHAPTERS = {
 ...
 "5 · Acting on it": {"intro": "Turning a score into action: the daily nudge engine, the recommended-actions catalogue, and how adherence and goals feed back into the model.",
 ...
 "6 · Care pathways & delivery": {"intro": "How the engine plugs into real care: condition-specific pathways, the care team and their roles, and the prevention/engagement layer that keeps patients in the loop.",
 ...
 "7 · Trust & govern": {"intro": "Why you can trust the number: cohort validation and calibration, the evidence registry behind every band, safety/escalation governance, consent, localization and actuarial fairness.",
 ...
 "8 · Gaps, blind-spots & roadmap": {"intro": "An honest ledger of what is not done. Product-readiness gaps for the patient app, the spec build-readiness audit, the clinician red-team, and the coverage audit — the work still ahead.",
 ...
 "9 · System & build": {"intro": "The whole machine as software: the system-at-a-glance map, patient and engagement state machines, the object/class model, and the ERD / C4 / API / sequence / story dossiers an engineer builds from.",
 ...
 "10 · Admin (clinician config)": {"intro": "The clinician-facing configuration surfaces — lab ranges, weights, lifestyle/PRO settings, personas and the governance sign-off flow — shown as interactive mockups.",
